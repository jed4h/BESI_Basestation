...
accelProcFile = open("Accelerometer2015-05-28", "r")
lightProcFile = open("Ambient Light2015-05-28", "r")
noiseProcFile = open("Ambient Noise2015-05-28", "r")
tempProcFile = open("Temperature2015-05-28", "r")
