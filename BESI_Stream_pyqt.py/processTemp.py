...
def processTemp(tempFile, port, DeploymentID):
    ...
    fname = "Data_Deployment_{0}/Relay_Station_{1}/Temperature/Temperature{2}_{3:02}-{4:02}".format(DeploymentID, port, dt.date(), dt.time().hour, dt.time().minute, DeploymentID)
